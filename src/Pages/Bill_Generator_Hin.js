...
function HindiBill() {
  ...
  const copyMessage = () => {
    ...
    const message = `नमस्ते 🙏, ${selectedConsumer.name},\n\nयह हरिप्रिया डेयरी फार्म की ओर से एक विनम्र अनुरोध है। आपकी जून माह की दूध बिल  ₹${amount} बकाया है। कृपया असुविधा से बचने हेतु 5 अगस्त 2025 से पहले भुगतान करें।\n\n यदि आपने पहले ही भुगतान कर दिया है, तो कृपया इस संदेश को नज़रअंदाज़ करें।\n\nआपके सहयोग के लिए धन्यवाद!\n— हरिप्रिया डेयरी फार्म`;
